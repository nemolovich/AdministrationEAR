...
--------------- Cr�ation de la table FILE_PATH --------------
-- TABLE:			FILE_PATH
...
--  soci�t�s qui requierent des services.
...
--  doit �tre un client sur la table ROOT.CLIENT.
ALTER TABLE ROOT.CLIENT ADD CONSTRAINT client_c_user_id_fk
                FOREIGN KEY (id_user)
                REFERENCES ROOT.C_USER(id);

----------------- Cr�ation de la table MAIL -----------------
-- TABLE:			MAIL
-- DESCRIPTION: 	Table concernant les mails associ�s �
--  des utilisateurs dans une soci�t�.
...
------------- Cr�ation de la table WORKSTATION --------------
-- TABLE:			WORKSTATION
-- DESCRIPTION: 	Table concernant les postes de travail
--  utilis�s par les utilistaurs dans une soci�t�.
...
--------------- Cr�ation de la table SOFTWARE ---------------
-- TABLE:			SOFTWARE
-- DESCRIPTION: 	Table concernant les logiciels utilis�s
--  par un client ou une soci�t�.
...
----------------- Cr�ation de la table TASK -----------------
-- TABLE:			TASK
-- DESCRIPTION: 	Table concernant les t�ches � effectuer
--  ou d�j� effectu�es.
...
------------- Cr�ation de la table INTERVENTION -------------
-- TABLE:			INTERVENTION
